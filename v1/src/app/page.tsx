...
export default function Home() {
  return (
    <div className="relative min-h-screen w-full bg-zinc-950 overflow-visible">
      {/* Fullscreen light rays behind everything */}
      <LightRays className="pointer-events-none absolute inset-0 w-full h-full z-0" />

      {/* Decorative wavy layer (doesn't clip the rays now) */}
      <WavyBackground className="relative z-[1] mx-auto pb-40">
        {/* Content */}
        <div className="relative z-[2] mx-auto flex min-h-screen max-w-8xl flex-col items-center justify-center gap-2 px-6 text-center">
          <h1
            className="font-rubik text-center 
                       sm:text-7xl md:text-8xl lg:text-9xl text-6xl pt-40
